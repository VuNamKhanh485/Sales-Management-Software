...
public interface OrderTransactionRepository extends JpaRepository<OrderTransaction, Long> {
        ...
        // Lưu ý: Spring Data JPA (Hibernate) bắt buộc phải truyền đường dẫn file DTO
        // tuyệt đối (fully qualified) vào trong @Query("SELECT new ...")
        ...
        @Query("SELECT COUNT(o) > 0 FROM OrderTransaction o WHERE o.branchId = :branchId OR o.fromBranchId = :branchId OR o.toBranchId = :branchId")
        boolean existsByAnyBranchId(@Param("branchId") Long branchId);
}
